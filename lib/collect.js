...
async function nuvemshop(){
 ...
 let batch=await getJSON(url,{Authentication:'bearer '+env.NUVEMSHOP_TOKEN,Authorization:'Bearer '+env.NUVEMSHOP_TOKEN,'User-Agent':env.NUVEMSHOP_USER_AGENT},host);
